...
import jsceneviewer.inventor.qt.SoQtStandardEventTranslator.LocationRefreshMouseEvent;
import jsceneviewer.inventor.qt.devices.SoQtDevice;
...
void synthesizeCurrentButtonState (MouseEvent me, EventType type)
{
    ...
    if (buttonState != storedButtonState) {
        ...
        synthesizeButtonState (buttonState, SWT.BUTTON2,   me, false);
        synthesizeButtonState (buttonState, SWT.BUTTON3, me, false);
        // then generate button press events for every button that is different:
        synthesizeButtonState (buttonState, SWT.BUTTON1,  me, true);
        synthesizeButtonState (buttonState, SWT.BUTTON2,   me, true);
        synthesizeButtonState (buttonState, SWT.BUTTON3, me, true);
    }
}
...
void synthesizeCurrentModifierState (int modifiers, Widget widget)
{
...
void synthesizeModifierState (int newModifiers,
                                           int modifier,
                                           int keyCode, boolean press, Widget widget)
{
    // generate a button press or release event if the button state of the selected button
    // is different and the new state correlates with the "press" flag:
